%% FIXME:
% As it stands the paper's introduction is garbage.
% Either:
%   Show examples for shitty frameworks that can't do what Radiance can
%   Focus more on the new perspective rather than making the impossible possible
