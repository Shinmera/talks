...
\end{lispcode}
  \pause
  \vskip 1cm
  {\footnotesize\code{alternatively}}
\begin{lispcode}
...
\begin{frame}
  ...
  \item URLs can be arbitrarily rewritten
  \item Easy to set up with shorthands
  \end{itemize}
\end{frame}
...
\begin{frame}
  \title{3. Environments}
  \begin{itemize}
  \item Specify interface to implementation mapping
